 ...
 * basic accessor functions. If an Z-ordinate value is not specified or not
 * defined, constructed coordinates have a Z-ordinate of <code>NaN</code> (which
 * is also the value of <code>NULL_ORDINATE</code>). The standard comparison
 * functions ignore the Z-ordinate.
 * 
 * @version 1.7
 */
public class Coordinate implements Comparable<Object>, Cloneable, Serializable {
    ...
    /**
     * The value used to indicate a null or missing ordinate value. In
     * particular, used for the value of ordinates for dimensions greater than
     * the defined dimension of a coordinate.
     */
     ...
     */
    public static class DimensionalComparator implements Comparator<Object> {
        /**
